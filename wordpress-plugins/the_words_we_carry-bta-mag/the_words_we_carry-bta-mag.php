...
define( 'TWWC_BTA_MAG_READER_DISPLAY_VERSION', '3.0.0' );
			...
			<table class="form-table" role="presentation">
				...
				<tr>
					...
					<td>
						...
						<p class="description">Leave blank until the Magazine Content Plugin is installed. Suggested future endpoint: /wp-json/the-words-we-carry-content/v1/magazine</p>
					</td>
				</tr>
				<tr>
